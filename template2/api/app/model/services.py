...
db = redis.Redis(
    ...
    decode_responses=False  # We want raw bytes for our use case
)
...
async def model_predict(image_name):
    ...
    job_id = str(uuid4())  # Generate a unique identifier and convert it to string
    ...
    # Convert job data to JSON string and push to Redis queue
    ...
    while True:
        ...
        # Get the result from Redis using the job_id as key
